...
class MultiSwitchHandler : virtual public SimpleSwitchIf {
 public:
  explicit MultiSwitchHandler(MultiSwitch *sw)
    : switch_(sw) { }
  ...
  int32_t mirroring_mapping_add(const int32_t mirror_id,
    ...
    MultiSwitch::MirroringSessionConfig config = {};  // value-initialization
  ...
  int32_t mirroring_mapping_get_egress_port(const int32_t mirror_id) {
    ...
    MultiSwitch::MirroringSessionConfig config;
  ...
  void mirroring_session_add(const int32_t mirror_id,
    ...
    MultiSwitch::MirroringSessionConfig config_ = {};  // value-initialization
...
stdcxx::shared_ptr<SimpleSwitchIf> get_handler_multi(MultiSwitch *sw) {
  return stdcxx::shared_ptr<MultiSwitchHandler>(new MultiSwitchHandler(sw));
}
